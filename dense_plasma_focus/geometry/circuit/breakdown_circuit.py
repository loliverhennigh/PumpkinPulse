...
from dense_plasma_focus.geometry.breakdown.breakdown import Breakdown
...
class BreakdownCircuit(Compound):
    ...
    def __init__(
        ...
        linear_path_length = max((capacitor_width/2) - resistor_length, resistor_length/10.0)
        ...
        anode_resistor.joints["back_connector"].connect_to(breakdown_anode_cable.joints["front_connector"])
        cathode_resistor.joints["back_connector"].connect_to(breakdown_cathode_cable.joints["front_connector"])

        # Connect cable to breakdown
        breakdown_anode_cable.joints["back_connector"].connect_to(breakdown.joints["back_connector"])
