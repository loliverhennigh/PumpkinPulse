...
class EulerUpdate(Operator):
    ...
    def __init__(
        ...
        def _euler_update(
            ...
            # Make 4p stencil
            rho_4p_stencil = _4p_float32_stencil_type()
            vx_4p_stencil = _4p_float32_stencil_type()
            vy_4p_stencil = _4p_float32_stencil_type()
            vz_4p_stencil = _4p_float32_stencil_type()
            p_4p_stencil = _4p_float32_stencil_type()
            id_4p_stencil = _4p_uint8_stencil_type()

            # Make 4p stencil dxyz
            rho_4p_stencil_dxyz = _4p_vec3f_stencil_type()
            vx_4p_stencil_dxyz = _4p_vec3f_stencil_type()
            vy_4p_stencil_dxyz = _4p_vec3f_stencil_type()
            vz_4p_stencil_dxyz = _4p_vec3f_stencil_type()
            p_4p_stencil_dxyz = _4p_vec3f_stencil_type()
            ...
            for c in range(4):
                ...
                # Set stencil
                rho_4p_stencil[c] = local_rho_7p_stencil[0]
                vx_4p_stencil[c] = local_vx_7p_stencil[0]
                vy_4p_stencil[c] = local_vy_7p_stencil[0]
                vz_4p_stencil[c] = local_vz_7p_stencil[0]
                p_4p_stencil[c] = local_p_7p_stencil[0]
                id_4p_stencil[c] = local_id_7p_stencil[0]
                rho_4p_stencil_dxyz[c, 0] = rho_dxyz[0]
                rho_4p_stencil_dxyz[c, 1] = rho_dxyz[1]
                rho_4p_stencil_dxyz[c, 2] = rho_dxyz[2]
                vx_4p_stencil_dxyz[c, 0] = vx_dxyz[0]
                vx_4p_stencil_dxyz[c, 1] = vx_dxyz[1]
                vx_4p_stencil_dxyz[c, 2] = vx_dxyz[2]
                vy_4p_stencil_dxyz[c, 0] = vy_dxyz[0]
                vy_4p_stencil_dxyz[c, 1] = vy_dxyz[1]
                vy_4p_stencil_dxyz[c, 2] = vy_dxyz[2]
                vz_4p_stencil_dxyz[c, 0] = vz_dxyz[0]
                vz_4p_stencil_dxyz[c, 1] = vz_dxyz[1]
                vz_4p_stencil_dxyz[c, 2] = vz_dxyz[2]
                p_4p_stencil_dxyz[c, 0] = p_dxyz[0]
                p_4p_stencil_dxyz[c, 1] = p_dxyz[1]
                p_4p_stencil_dxyz[c, 2] = p_dxyz[2]
            ...
            for c in range(4):
                ...
                rho, vx, vy, vz, p = EulerUpdate._extrapolate_half_time_step(
                    rho_4p_stencil[c],
                    rho_4p_stencil_dxyz[c],
                    vx_4p_stencil[c],
                    vx_4p_stencil_dxyz[c],
                    vy_4p_stencil[c],
                    vy_4p_stencil_dxyz[c],
                    vz_4p_stencil[c],
                    vz_4p_stencil_dxyz[c],
                    p_4p_stencil[c],
                    p_4p_stencil_dxyz[c],
                    gamma,
                    dt,
            ...
            rho_faces = EulerUpdate._stencil_to_faces(rho_4p_stencil, rho_4p_stencil_dxyz, density.spacing)
            vx_faces = EulerUpdate._stencil_to_faces(vx_4p_stencil, vx_4p_stencil_dxyz, velocity.spacing)
            vy_faces = EulerUpdate._stencil_to_faces(vy_4p_stencil, vy_4p_stencil_dxyz, velocity.spacing)
            vz_faces = EulerUpdate._stencil_to_faces(vz_4p_stencil, vz_4p_stencil_dxyz, velocity.spacing)
            p_faces = EulerUpdate._stencil_to_faces(p_4p_stencil, p_4p_stencil_dxyz, pressure.spacing)
