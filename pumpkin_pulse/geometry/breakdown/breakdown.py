...
class Breakdown(Compound):
    ...
    def __init__(
        ...
        cable_conductor_0 = Location((0, 0, -breakdown_plate_thickness)) * Circle(
            cable_diameter / 2
        )
        cable_conductor_0 = loft(
            [cable_conductor_0, Rectangle(breakdown_width, breakdown_width)]
        )
        ...
        conductor_plate_1 = Location(
            (0, 0, breakdown_thickness + breakdown_plate_thickness)
        ) * Rectangle(breakdown_width, breakdown_width)
        ...
        cable_conductor_1 = Location(
            (0, 0, breakdown_thickness + 3 * breakdown_plate_thickness)
        ) * Circle(cable_diameter / 2)
        cable_conductor_1 = loft(
            [
                cable_conductor_1,
                Location((0, 0, 2 * breakdown_plate_thickness + breakdown_thickness))
                * Rectangle(breakdown_width, breakdown_width),
            ]
        )
        ...
        RigidJoint(
            ...
            joint_location=Location(
                (0, 0, 3 * breakdown_plate_thickness + breakdown_thickness), (0, 180, 0)
            ),
        )
        ...
        RigidJoint(
            ...
            to_part=self,
            joint_location=Location(
                (0, 0, -1 * breakdown_plate_thickness), (0, 0, 180)
            ),
        )
