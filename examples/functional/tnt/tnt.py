...
class CavityInitialize(Operator):
    ...
    def _initialize_cavity(
        ...
        tnt_density = 1650.0 # kg/m^3
        tnt_pressure = 1.0e10 # Pa

        # Initialize the density, velocity, and pressure
        if wp.int32(id) == 0:
            density.data[0, i, j, k] = air_density
            velocity.data[0, i, j, k] = 0.0
            velocity.data[1, i, j, k] = 0.0
            velocity.data[2, i, j, k] = 0.0
            pressure.data[0, i, j, k] = air_pressure
        else:
            density.data[0, i, j, k] = tnt_density
            velocity.data[0, i, j, k] = 0.0
            velocity.data[1, i, j, k] = 0.0
            velocity.data[2, i, j, k] = 0.0
            pressure.data[0, i, j, k] = tnt_pressure
