...
from pumpkin_pulse.operator.hydro.euler_final import (
...
if __name__ == '__main__':
    ...
    density_dxyz = constructor.create_field(
        dtype=wp.float32,
        cardinality=3,
        shape=shape,
    )
    velocity_dxyz = constructor.create_field(
        dtype=wp.float32,
        cardinality=9,
        shape=shape,
    )
    pressure_dxyz = constructor.create_field(
        dtype=wp.float32,
        cardinality=3,
        shape=shape,
    )
    ...
    with tqdm(total=simulation_time, desc="Simulation Progress") as pbar:
        while current_time < simulation_time:
            ...
            #            "velocity": velocity,
            #            "pressure": pressure,
            #            "density_dxyz": density_dxyz,
            #            "velocity_dxyz": velocity_dxyz,
            #            "pressure_dxyz": pressure_dxyz,
            #            "mass": mass,
            #            "momentum": momentum,
            #            "energy": energy,
            #        },
