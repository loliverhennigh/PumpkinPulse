...
class EulerUpdate(Operator):
    ...
    _scalar_stencil_type = wp.vec(7, wp.float32)
    _vector_stencil_type = wp.mat((7, 3), wp.float32)
    _scalar_faces_type = wp.vec(12, wp.float32)
    _scalar_fluxes_type = wp.vec(6, wp.float32)
    ...
    def _slope_limiter(
        ...
        v_dx = (
            wp.max(
                ...
                wp.min(
                    1.0,
                    ((v_1_1_1 - v_0_1_1) / spacing[0]) / denominator,
                ),
            )
            * v_dx
        )
        ...
        v_dx = (
            wp.max(
                ...
                wp.min(
                    1.0,
                    ((v_2_1_1 - v_1_1_1) / spacing[0]) / denominator,
                ),
            )
            * v_dx
        )
        ...
        v_dy = (
            wp.max(
                ...
                wp.min(
                    1.0,
                    ((v_1_1_1 - v_1_0_1) / spacing[1]) / denominator,
                ),
            )
            * v_dy
        )
        ...
        v_dy = (
            wp.max(
                ...
                wp.min(
                    1.0,
                    ((v_1_2_1 - v_1_1_1) / spacing[1]) / denominator,
                ),
            )
            * v_dy
        )
        ...
        v_dz = (
            wp.max(
                ...
                wp.min(
                    1.0,
                    ((v_1_1_1 - v_1_1_0) / spacing[2]) / denominator,
                ),
            )
            * v_dz
        )
        ...
        v_dz = (
            wp.max(
                ...
                wp.min(
                    1.0,
                    ((v_1_1_2 - v_1_1_1) / spacing[2]) / denominator,
                ),
            )
            * v_dz
        )
    ...
    def _get_stencil(
        ...
        # Get Center Box
        v_2_1_1 = periodic_indexing(field.data, field.shape, c, i + 0, j - 1, k - 1)
        v_1_2_1 = periodic_indexing(field.data, field.shape, c, i - 1, j + 0, k - 1)
        v_2_2_1 = periodic_indexing(field.data, field.shape, c, i + 0, j + 0, k - 1)
        v_3_2_1 = periodic_indexing(field.data, field.shape, c, i + 1, j + 0, k - 1)
        v_2_3_1 = periodic_indexing(field.data, field.shape, c, i + 0, j + 1, k - 1)
        v_1_1_2 = periodic_indexing(field.data, field.shape, c, i - 1, j - 1, k + 0)
        v_2_1_2 = periodic_indexing(field.data, field.shape, c, i + 0, j - 1, k + 0)
        v_3_1_2 = periodic_indexing(field.data, field.shape, c, i + 1, j - 1, k + 0)
        v_1_2_2 = periodic_indexing(field.data, field.shape, c, i - 1, j + 0, k + 0)
        v_2_2_2 = periodic_indexing(field.data, field.shape, c, i + 0, j + 0, k + 0)
        v_3_2_2 = periodic_indexing(field.data, field.shape, c, i + 1, j + 0, k + 0)
        v_1_3_2 = periodic_indexing(field.data, field.shape, c, i - 1, j + 1, k + 0)
        v_2_3_2 = periodic_indexing(field.data, field.shape, c, i + 0, j + 1, k + 0)
        v_3_3_2 = periodic_indexing(field.data, field.shape, c, i + 1, j + 1, k + 0)
        v_2_1_3 = periodic_indexing(field.data, field.shape, c, i + 0, j - 1, k + 1)
        v_1_2_3 = periodic_indexing(field.data, field.shape, c, i - 1, j + 0, k + 1)
        v_2_2_3 = periodic_indexing(field.data, field.shape, c, i + 0, j + 0, k + 1)
        v_3_2_3 = periodic_indexing(field.data, field.shape, c, i + 1, j + 0, k + 1)
        v_2_3_3 = periodic_indexing(field.data, field.shape, c, i + 0, j + 1, k + 1)

        # Get edges
        v_0_2_2 = periodic_indexing(field.data, field.shape, c, i - 2, j + 0, k + 0)
        v_4_2_2 = periodic_indexing(field.data, field.shape, c, i + 2, j + 0, k + 0)
        v_2_0_2 = periodic_indexing(field.data, field.shape, c, i + 0, j - 2, k + 0)
        v_2_4_2 = periodic_indexing(field.data, field.shape, c, i + 0, j + 2, k + 0)
        v_2_2_0 = periodic_indexing(field.data, field.shape, c, i + 0, j + 0, k - 2)
        v_2_2_4 = periodic_indexing(field.data, field.shape, c, i + 0, j + 0, k + 2)

        # Get derivatives
        v_2_2_2_xyz = EulerUpdate._centeral_difference(
            v_1_2_2, v_3_2_2, v_2_1_2, v_2_3_2, v_2_2_1, v_2_2_3, field.spacing
        )
        v_1_2_2_xyz = EulerUpdate._centeral_difference(
            v_0_2_2, v_2_2_2, v_1_1_2, v_1_3_2, v_1_2_1, v_1_2_3, field.spacing 
        )
        v_3_2_2_xyz = EulerUpdate._centeral_difference(
            v_2_2_2, v_4_2_2, v_3_1_2, v_3_3_2, v_3_2_1, v_3_2_3, field.spacing
        )
        v_2_1_2_xyz = EulerUpdate._centeral_difference(
            v_1_1_2, v_3_1_2, v_2_0_2, v_2_2_2, v_2_1_1, v_2_1_3, field.spacing
        )
        v_2_3_2_xyz = EulerUpdate._centeral_difference(
            v_1_3_2, v_3_3_2, v_2_2_2, v_2_4_2, v_2_3_1, v_2_3_3, field.spacing
        )
        v_2_2_1_xyz = EulerUpdate._centeral_difference(
            v_1_2_1, v_3_2_1, v_2_1_1, v_2_3_1, v_2_2_0, v_2_2_2, field.spacing
        )
        v_2_2_3_xyz = EulerUpdate._centeral_difference(
            v_1_2_3, v_3_2_3, v_2_1_3, v_2_3_3, v_2_2_2, v_2_2_4, field.spacing
        )

        # Slope limiter
        v_2_2_2_xyz = EulerUpdate._slope_limiter(
            v_2_2_2, v_1_2_2, v_3_2_2, v_2_1_2, v_2_3_2, v_2_2_1, v_2_2_3, v_2_2_2_xyz, field.spacing
        )
        v_1_2_2_xyz = EulerUpdate._slope_limiter(
            v_1_2_2, v_0_2_2, v_2_2_2, v_1_1_2, v_1_3_2, v_1_2_1, v_1_2_3, v_1_2_2_xyz, field.spacing
        )
        v_3_2_2_xyz = EulerUpdate._slope_limiter(
            v_3_2_2, v_2_2_2, v_4_2_2, v_3_1_2, v_3_3_2, v_3_2_1, v_3_2_3, v_3_2_2_xyz, field.spacing
        )
        v_2_1_2_xyz = EulerUpdate._slope_limiter(
            v_2_1_2, v_1_1_2, v_3_1_2, v_2_0_2, v_2_2_2, v_2_1_1, v_2_1_3, v_2_1_2_xyz, field.spacing
        )
        v_2_3_2_xyz = EulerUpdate._slope_limiter(
            v_2_3_2, v_1_3_2, v_3_3_2, v_2_2_2, v_2_4_2, v_2_3_1, v_2_3_3, v_2_3_2_xyz, field.spacing
        )
        v_2_2_1_xyz = EulerUpdate._slope_limiter(
            v_2_2_1, v_1_2_1, v_3_2_1, v_2_1_1, v_2_3_1, v_2_2_0, v_2_2_2, v_2_2_1_xyz, field.spacing
        )
        v_2_2_3_xyz = EulerUpdate._slope_limiter(
            v_2_2_3, v_1_2_3, v_3_2_3, v_2_1_3, v_2_3_3, v_2_2_2, v_2_2_4, v_2_2_3_xyz, field.spacing
        )

        # Make stencil
        stencil = EulerUpdate._scalar_stencil_type(
            v_2_2_2,
            v_1_2_2,
            v_3_2_2,
            v_2_1_2,
        ...
        stencil_dxyz = EulerUpdate._vector_stencil_type(
    ...
    def _stencil_to_faces(
        v_stencil: _scalar_stencil_type,
        v_stencil_dxyz: _vector_stencil_type,
        spacing: wp.vec3f,
    ):

        # Make faces
        faces = EulerUpdate._scalar_faces_type()
    ...
    def _do_nothing_boundary_conditions(
        ...
        spacing: wp.vec3f,
        shape: wp.vec3i,
        rho_stencil: _scalar_stencil_type,
        rho_stencil_dxyz: _vector_stencil_type,
        vx_stencil: _scalar_stencil_type,
        vx_stencil_dxyz: _vector_stencil_type,
        vy_stencil: _scalar_stencil_type,
        vy_stencil_dxyz: _vector_stencil_type,
        vz_stencil: _scalar_stencil_type,
        vz_stencil_dxyz: _vector_stencil_type,
        p_stencil: _scalar_stencil_type,
        p_stencil_dxyz: _vector_stencil_type,
        gamma: wp.float32,
        dt: wp.float32,
    ):
    ...
    def __init__(
        self,
        apply_boundary_conditions: Callable,
        apply_boundary_conditions_dxyz: Callable,
    ):
        ...
        def _euler_update(
            ...
            # Get stencil
            rho_stencil, rho_stencil_dxyz = EulerUpdate._get_stencil(density, 0, i, j, k)
            vx_stencil, vx_stencil_dxyz = EulerUpdate._get_stencil(velocity, 0, i, j, k)
            vy_stencil, vy_stencil_dxyz = EulerUpdate._get_stencil(velocity, 1, i, j, k)
            vz_stencil, vz_stencil_dxyz = EulerUpdate._get_stencil(velocity, 2, i, j, k)
            p_stencil, p_stencil_dxyz = EulerUpdate._get_stencil(pressure, 0, i, j, k)
            ...
            rho_stencil, rho_stencil_dxyz, vx_stencil, vx_stencil_dxyz, vy_stencil, vy_stencil_dxyz, vz_stencil, vz_stencil_dxyz, p_stencil, p_stencil_dxyz = self.apply_boundary_conditions(
                i, j, k, density.origin, density.spacing, density.shape,
                rho_stencil, rho_stencil_dxyz, vx_stencil, vx_stencil_dxyz, vy_stencil, vy_stencil_dxyz, vz_stencil, vz_stencil_dxyz, p_stencil, p_stencil_dxyz,
                gamma, dt
            )

            # Get faces
            rho_faces = EulerUpdate._stencil_to_faces(rho_stencil, rho_stencil_dxyz, density.spacing)
            vx_faces = EulerUpdate._stencil_to_faces(vx_stencil, vx_stencil_dxyz, velocity.spacing)
            vy_faces = EulerUpdate._stencil_to_faces(vy_stencil, vy_stencil_dxyz, velocity.spacing)
            vz_faces = EulerUpdate._stencil_to_faces(vz_stencil, vz_stencil_dxyz, velocity.spacing)
            p_faces = EulerUpdate._stencil_to_faces(p_stencil, p_stencil_dxyz, pressure.spacing)

            # Allocate fluxes
            flux_faces_mass = self._scalar_fluxes_type()
            flux_faces_mom_x = self._scalar_fluxes_type()
            flux_faces_mom_y = self._scalar_fluxes_type()
            flux_faces_mom_z = self._scalar_fluxes_type()
            flux_faces_energy = self._scalar_fluxes_type()
            ...
            if self.inside_domain(i - 1, j, k, density.origin, density.spacing, density.shape) == wp.uint8(0):
                flux_faces_mass[0] = 0.0
                #flux_faces_mom_x[0] = 0.0
                #flux_faces_mom_y[0] = 0.0
                #flux_faces_mom_z[0] = 0.0
                flux_faces_energy[0] = 0.0
            #if self.inside_domain(i + 1, j, k, density.origin, density.spacing, density.shape) == wp.uint8(0):
            #    flux_faces_mass[1] = 0.0
            #    #flux_faces_mom_x[1] = 0.0
            #    #flux_faces_mom_y[1] = 0.0
            #    #flux_faces_mom_z[1] = 0.0
            #    flux_faces_energy[1] = 0.0
            #if self.inside_domain(i, j - 1, k, density.origin, density.spacing, density.shape) == wp.uint8(0):
            #    flux_faces_mass[2] = 0.0
            #    #flux_faces_mom_x[2] = 0.0
            #    #flux_faces_mom_y[2] = 0.0
            #    #flux_faces_mom_z[2] = 0.0
            #    flux_faces_energy[2] = 0.0
            #if self.inside_domain(i, j + 1, k, density.origin, density.spacing, density.shape) == wp.uint8(0):
            #    flux_faces_mass[3] = 0.0
            #    #flux_faces_mom_x[3] = 0.0
            #    #flux_faces_mom_y[3] = 0.0
            #    #flux_faces_mom_z[3] = 0.0
            #    flux_faces_energy[3] = 0.0
