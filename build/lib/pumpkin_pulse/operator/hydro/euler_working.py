...
class EulerUpdate(Operator):
    ...
    def __init__(
        ...
        def _euler_update(
            ...
            # Apply boundary conditions
            rho_p4_stencil, vx_p4_stencil, vy_p4_stencil, vz_p4_stencil, p_p4_stencil = apply_boundary_conditions_p4(
               rho_p4_stencil,
               vx_p4_stencil,
               vy_p4_stencil,
               vz_p4_stencil,
            ...
            rho_p4_stencil_dxyz, vx_p4_stencil_dxyz, vy_p4_stencil_dxyz, vz_p4_stencil_dxyz, p_p4_stencil_dxyz = apply_boundary_conditions_p4_dxyz(
               rho_p4_stencil_dxyz,
               vx_p4_stencil_dxyz,
               vy_p4_stencil_dxyz,
               vz_p4_stencil_dxyz,
